...
JSBool js_ls_GameCenterBridge_showadmobtop(JSContext *cx, uint32_t argc, jsval *vp)
{
	JSBool ok = JS_TRUE;
...
void js_register_ls_GameCenterBridge(JSContext *cx, JSObject *global) {
	...
	static JSFunctionSpec funcs[] = {
        ...
        JS_FN("showadmobtop", js_ls_GameCenterBridge_showadmobtop, 1, JSPROP_PERMANENT | JSPROP_ENUMERATE),
        JS_FS_END
	};
